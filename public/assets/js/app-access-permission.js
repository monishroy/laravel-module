...
$(function () {
  ...
  a.length &&
    (e = a.DataTable({
      ajax: "https://demos.pixinvent.com/vuexy-html-admin-template/assets/json/permissions-list.json",
      columns: [
        { data: "" },
        { data: "id" },
        { data: "name" },
      ...
      columnDefs: [
        ...
        { targets: 1, searchable: !1, visible: !1 },
        {
          ...
          render: function (e, a, t, s) {
            return (
              '<span class="text-nowrap text-heading">' + t.name + "</span>"
            );
          },
        },
        {
              ...
              var n = t.assigned_to,
                ...
                o = {
                  ...
                  Users:
                    '<a href="' +
                    d +
                    '"><span class="badge me-4 bg-label-success">Users</span></a>',
                  Support:
                    '<a href="' +
                    d +
                    '"><span class="badge me-4 bg-label-info">Support</span></a>',
                  Restricted:
                    '<a href="' +
                    d +
      ...
      buttons: [
        {
          ...
          className:
            "add-new btn btn-primary mb-6 mb-md-0 waves-effect waves-light",
          attr: {
